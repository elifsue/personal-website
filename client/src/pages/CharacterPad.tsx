...
const userReviews = [
  { id: 1, finding: "Hard to Find Specific Characters / Symbols", severity: "High", complaints: 87, upvotes: 367, area: "Search" },
  { id: 2, finding: "Characters Not Displayed / Blank Boxes / Unsupported", severity: "High", complaints: 47, upvotes: 244, area: "Onboarding" },
  { id: 3, finding: "Language Barrier (English Only)", severity: "High", complaints: 26, upvotes: 240, area: "Search" },
  { id: 4, finding: "Difficult to Use / Not Intuitive / Confusing UX", severity: "High", complaints: 46, upvotes: 135, area: "Onboarding" },
  { id: 5, finding: "Accidental Text Deletion (Clear Button Placement)", severity: "High", complaints: 2, upvotes: 94, area: "UX" },
  { id: 6, finding: "Accidental Scrolling", severity: "Medium", complaints: 3, upvotes: 85, area: "Navigation" },
  { id: 7, finding: "Text Composer Placement Causes Search Bar Confusion", severity: "Medium", complaints: 3, upvotes: 74, area: "UX" },
  { id: 8, finding: "Characters Too Small / No Zoom", severity: "Medium", complaints: 4, upvotes: 31, area: "UX" },
  { id: 9, finding: "Cannot Create Custom Characters", severity: "Medium", complaints: 6, upvotes: 27, area: "Onboarding" },
  { id: 10, finding: "Not a Keyboard / Expected Keyboard Integration", severity: "Low", complaints: 26, upvotes: 120, area: "Onboarding" },
  { id: 11, finding: "Floating Clipboard Quick Access", severity: "Low", complaints: 5, upvotes: 37, area: "Navigation" },
  { id: 12, finding: "Floating Clipboard Sizing Configuration", severity: "Low", complaints: 4, upvotes: 24, area: "UX" },
];
