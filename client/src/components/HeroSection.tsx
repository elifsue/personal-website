...
export default function HeroSection() {
  ...
  return (
    ...
    >
      {/* Decorative blob background image — scaled up to prevent white edges during parallax */}
      <div
        ref={blobRef}
        className="absolute transition-transform duration-700 ease-out pointer-events-none"
        style={{ inset: "-30px", willChange: "transform" }}
      >
        <img
          src={HERO_BG}
          alt=""
      ...
      <div className="relative z-10 w-full min-h-screen flex flex-col px-8 lg:px-32 pt-20 lg:pt-0">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-3xl py-8">
          ...
          >
            ...
            <a
              ...
              className="group relative overflow-hidden flex items-center gap-2 px-8 py-4 rounded-full font-medium text-sm tracking-wide transition-all duration-300"
