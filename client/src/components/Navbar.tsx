    ...
    <>
      ...
      <nav className="hidden lg:flex fixed left-0 top-0 h-full w-20 flex-col items-center justify-between py-10 z-50"
        ...
        <div className="flex flex-col items-center gap-3">
          <a href="mailto:elifsuates1516@gmail.com" className="w-8 h-8 flex items-center justify-center rounded-full transition-all duration-300 hover:scale-110"
            style={{ color: "#6B6560" }}
            title="elifsuates1516@gmail.com">
